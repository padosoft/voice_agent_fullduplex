 ...
 */
export class BrowserRealtimeAudioBridge {
    mediaDevices;
    contextFactory;
    targetSampleRate;
    context = null;
    ...
    nextPlaybackAt = 0;
    playing = new Set();
    constructor(mediaDevices = globalThis.navigator?.mediaDevices, contextFactory = () => new AudioContext(), targetSampleRate = 16_000) {
    ...
    play(base64Pcm, sampleRate) {
        if (this.muted || !this.context || !base64Pcm)
            return 0;
