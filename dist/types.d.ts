...
export declare const WIRE_SCHEMAS: readonly ["realtime-agent-state@1", "realtime-agent-surface@1", "realtime-agent-tool-call@1", "realtime-agent-tool-result@1", "realtime-agent-ui-command@1", "realtime-agent-event@1", "realtime-agent-goal@1", "realtime-agent-confirmation@1", "realtime-agent-connection@1", "realtime-agent-message@1", "realtime-agent-usage@1", "realtime-agent-audit@1"];
...
export type SurfaceActionHandler = (context: SurfaceActionContext) => Promise<unknown> | unknown;
...
export type RealtimeAgentClientEvent = CanonicalProviderEvent | {
    type: "state.updated";
    state: AgentState;
} | {
    type: "surface.synced";
